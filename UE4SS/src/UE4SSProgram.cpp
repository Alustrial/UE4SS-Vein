...
#include <MacroSetter.hpp>
    ...
    auto UE4SSProgram::on_program_start() -> void
    {
        ...
        // VeinCF: DX12 ImGui overlay DISABLED — using native UMG widgets instead.
        // Kept for reference; may revisit with a proven DX12 hook approach later.
        // if (!GUI::DX12Overlay::install())
        // {
        //     Output::send<LogLevel::Warning>(STR("[VeinCF] DX12 overlay install failed — in-game UI will not be available\n"));
        // }
